...
x_sig = TreeToArray(tree0, "x")
y_sig = TreeToArray(tree0, "y")
hits_sig = TreeToArray(tree0, "AnzahlHits")

x_u = TreeToArray(tree1, "x")
y_u = TreeToArray(tree1, "y")
hits_u = TreeToArray(tree1, "AnzahlHits")
...
for i in test_val:
    results = np.append(results, kNN(train_val, train_label, i, 20))
