...
def f(Lambda):
    return (Lambda -30*np.log(Lambda) + np.log(math.factorial(13)) + np.log(math.factorial(9))+ np.log(math.factorial(8)))

x = np.linspace(0.000001,80,10000)
plt.plot(x, f(x), 'g-', label=r'$-ln(L)$')
plt.axvline(30, linestyle = '--', color = 'r', label =r'$\lambda_{min}$')
plt.axhline(f(30)+1/2, linestyle = '--', color = 'b', label =r'$-ln(L_{max})+\frac{1}{2}$')
plt.axhline(f(30)+2, linestyle = '--', color = 'y', label =r'$-ln(L_{max})+2$')
plt.axhline(f(30)+9/2, linestyle = '--', color = 'm', label =r'$-ln(L_{max})+\frac{9}{2}$')
#plt.axvspan()
#plt.ylim(-100,200)
#plt.xlabel(r'$\lambda$')
#plt.ylabel(r'$-ln(L)$')
...
def g(Lambda, a):
    return (Lambda - 30*np.log(Lambda) -30 + 30*np.log(30)-a)
...
interval1 = np.array([h(1/2, 29.5), h(1/2,30.5)])
interval2 = np.array([h(2, 20), h(2, 40)])
interval3 = np.array([h(9/2, 17), h(9/2, 50)])
...
def T_2(Lambda):
    return (30 - 30*np.log(30) + np.log(math.factorial(13)) + np.log(math.factorial(9))+ np.log(math.factorial(8)) + 1/60*(Lambda-30)**2)

x = np.linspace(0.000001,80,10000)
plt.plot(x, f(x), 'k-', label=r'$-ln(L)$')
plt.axvline(30, linestyle = '--', color = 'r', label =r'$\lambda_{min}$')
plt.plot(x, T_2(x), 'g-', label=r'$T_2(30,-ln(L))$')
plt.axhline(T_2(30)+1/2, linestyle = '--', color = 'b', label =r'$T_2(\lambda_{max})+\frac{1}{2}$')
plt.axhline(T_2(30)+2, linestyle = '--', color = 'y', label =r'$T_2(\lambda_{max})+2$')
plt.axhline(T_2(30)+9/2, linestyle = '--', color = 'm', label =r'$T_2(\lambda_{max})+\frac{9}{2}$')
#plt.axvspan()
#plt.ylim(-100,200)
#plt.xlabel(r'$\lambda$')
#plt.ylabel(r'$values$')
...
t_interval1 = np.array([p(1/2, 29.5), p(1/2,30.5)])
t_interval2 = np.array([p(2, 20), p(2, 40)])
t_interval3 = np.array([p(9/2, 17), p(9/2, 50)])
